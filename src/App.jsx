  ...
  biochemistry: async () => {
    ...
    return {
      ...
      meta: {
        ...
        answerNote: '已收录第 01～18 讲题组；每题均只关联本讲讲义页，选项与答案均已按讲义复核。',
      },

...
const groups = [
  ...
  choiceGroup({
    ...
    options: [
      '等渗、口感好、最常用',
      '以氨基酸、多肽等为主，残渣少，无需消化即可吸收且不含乳糖',
      '适用于回肠肠瘘', '适用于短肠综合征', '适用于胰腺炎',
      '适合有特殊营养需求者',
      '糖尿病：减少葡萄糖、增加脂肪乳剂量',
      '慢性肾衰：低磷、低蛋白，不需限制糖',
    ],
  ...
  choiceGroup({
    ...
    options: [
      '1周以上不能进食、胃肠道功能障碍或肠内营养无法达标',
      '高位小肠瘘', '短肠综合征', '重症胰腺炎', '急性肾衰',
      '严重感染', '严重烧伤', '溃疡性结肠炎长期腹泻',
      '恶性肿瘤放化疗期间严重呕吐',
      '甲亢术后饮水呛咳', '脑外伤昏迷', '幽门梗阻',
      '上肢末梢静脉输注',
      'PICC、锁骨下静脉或颈内静脉输注',
      '完全肠外营养（TPN）',
      '尽早改为肠内营养，采用鼻空肠管或空肠造口',
    ],
    stems: [
      ['肠外营养适应证', ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I']],
      ['不需要肠外营养', ['J', 'K', 'L']],
      ['肠外营养＜2周', ['M']],
      ['肠外营养＞2周', ['N']],
      ['重症胰腺炎禁食期', ['O']],
